...
- 22-12-16. Now can use [DPM-Solver](https://github.com/LuChengTHU/dpm-solver) for the fast sampling (1000 steps ❌ 20 steps ⭕️) 🥳  Just set ``--dpm_solver True`` in the sampling stage. 
## Example Cases
